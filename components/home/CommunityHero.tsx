...
//             if (isOdd) {
//                 return (
//                     <p key={index} className='gfs-didot-regular-italic text-[#FFFFFF] text-[28px] leading-[40px] tracking-[-0.01em] md:leading-[80px] md:text-[52x]'>
//                         {word}
//                     </p>
//                 );
//             } else {
//                 return (
//                     <span key={index} className='gfs-didot-regular text-[#FFFFFF] text-[28px] leading-[40px] tracking-[-0.01em] md:leading-[80px] md:text-[72px]'>
//                         {word}
//                     </span>
//                 );
//             }
...
//                     <p className="text-[#F9F8F4] text-xs mb-2 libre-baskerville-regular">{topHeading}</p>
...
//                         <p className="text-[#FFFFFF] font-normal text-[10px] leading-[19px] tracking-[0.12em] font-helvetica mb-2 md:mb-3 md:libre-baskerville-regular">{aboutTitle}</p>
//                         <h3 className="text-[#FFFFFF] font-normal text-[14px] leading-[25px] md:text-[18px] md:leading-[19px] mb-2 md:mb-3 libre-baskerville-regular">{aboutSubtitle}</h3>
...
const CommunityHero: React.FC<CommunityHeroProps> = ({
  ...
  // Parallax extension effect on scroll
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      {
        scale: 1,
        padding: "3rem", // same as home page community section
        ease: "none",
        scrollTrigger: {
          trigger: heroImageRef.current,
          start: "top bottom", // start when image enters viewport
          end: "bottom top", // end when image exits
          scrub: true,
        },
      }
    );
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-black/20 object-cover group-hover:bg-black/30 transition-colors duration-300"></div>
